...
Now keeping in mind the above two rules we have,
$p_{1}  = a - b \\
q_{1}  = p_1*c$ \\
$p_{2}$  = u*v // $p_{1}$ as already been used once in the LHS \\ 
$q_{2}  = p_{2} + q_{1}$ // $q_{1}$ has already been used once before \\ 
